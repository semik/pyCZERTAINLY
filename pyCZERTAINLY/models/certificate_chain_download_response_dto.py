...
class CertificateChainDownloadResponseDto(BaseModel):
    """
    CertificateChainDownloadResponseDto
    """ # noqa: E501
    format: CertificateFormat
    encoding: CertificateFormatEncoding
    content: StrictStr = Field(description="Base64 encoded content in the specified format and encoding")
    complete_chain: StrictBool = Field(description="Indicator whether the chain returned is complete", alias="completeChain")
    __properties: ClassVar[List[str]] = ["format", "encoding", "content", "completeChain"]
