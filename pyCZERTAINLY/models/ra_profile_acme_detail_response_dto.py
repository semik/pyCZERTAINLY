...
class RaProfileAcmeDetailResponseDto(BaseModel):
    """
    ...
    acme_available: StrictBool = Field(description="ACME availability flag - true = yes; false = no", alias="acmeAvailable")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "acmeAvailable", "directoryUrl", "issueCertificateAttributes", "revokeCertificateAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uuid": obj.get("uuid"),
            "name": obj.get("name"),
            "acmeAvailable": obj.get("acmeAvailable"),
