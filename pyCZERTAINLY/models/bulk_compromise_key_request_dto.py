...
class BulkCompromiseKeyRequestDto(BaseModel):
    """
    BulkCompromiseKeyRequestDto
    """ # noqa: E501
    reason: KeyCompromiseReason
    uuids: Optional[List[StrictStr]] = Field(default=None, description="List of UUIDs of the keys. This will mark all the items inside the selected key as compromised")
