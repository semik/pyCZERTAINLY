...
class RuleRequestDto(BaseModel):
    ...
    resource: Resource
    conditions_uuids: List[StrictStr] = Field(description="List of UUIDs of existing conditions to add to the rule", alias="conditionsUuids")
    __properties: ClassVar[List[str]] = ["name", "description", "resource", "conditionsUuids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditionsUuids": obj.get("conditionsUuids")
        })
        return _obj
