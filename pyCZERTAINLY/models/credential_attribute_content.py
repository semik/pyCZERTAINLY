...
class CredentialAttributeContent(BaseModel):
    """
    CredentialAttributeContent
    """ # noqa: E501
    reference: Optional[StrictStr] = Field(default=None, description="Content Reference")
    data: CredentialAttributeContentData
    __properties: ClassVar[List[str]] = ["reference", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CredentialAttributeContentData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
