...
class UploadCertificateRequestDto(BaseModel):
    """
    UploadCertificateRequestDto
    """ # noqa: E501
    certificate: StrictStr = Field(description="Base64 Content of the Certificate")
    custom_attributes: List[RequestAttributeDto] = Field(description="Custom Attributes for the Certificate", alias="customAttributes")
    __properties: ClassVar[List[str]] = ["certificate", "customAttributes"]
