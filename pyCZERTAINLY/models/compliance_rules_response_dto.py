...
class ComplianceRulesResponseDto(BaseModel):
    """
    Rules from Compliance Provider
    """ # noqa: E501
    uuid: StrictStr = Field(description="UUID of the rule")
    group_uuid: Optional[StrictStr] = Field(default=None, description="UUID of the group to which the rule belongs to", alias="groupUuid")
    name: StrictStr = Field(description="Name of the rule")
    certificate_type: CertificateType = Field(alias="certificateType")
    attributes: Optional[List[BaseAttributeDto]] = Field(default=None, description="Rule attributes")
    description: Optional[StrictStr] = Field(default=None, description="Description of the rule")
    __properties: ClassVar[List[str]] = ["uuid", "groupUuid", "name", "certificateType", "attributes", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [BaseAttributeDto.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
