...
class RoleRequestDto(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description for the role")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "email", "customAttributes"]
