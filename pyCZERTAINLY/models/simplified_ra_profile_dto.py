...
class SimplifiedRaProfileDto(BaseModel):
    """
    ...
    authority_instance_uuid: Optional[StrictStr] = Field(default=None, description="Authority Instance UUID", alias="authorityInstanceUuid")
    __properties: ClassVar[List[str]] = ["uuid", "name", "enabled", "authorityInstanceUuid"]
