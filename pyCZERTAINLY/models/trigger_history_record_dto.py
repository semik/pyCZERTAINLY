...
class TriggerHistoryRecordDto(BaseModel):
    """
    List of records for each action that has not been performed and each condition that has not been evaluated.
    """ # noqa: E501
    message: StrictStr = Field(description="Message with cause of action/condition failure.")
    condition: Optional[ConditionDto] = None
    execution: Optional[ExecutionDto] = None
    __properties: ClassVar[List[str]] = ["message", "condition", "execution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "condition": ConditionDto.from_dict(obj["condition"]) if obj.get("condition") is not None else None,
            "execution": ExecutionDto.from_dict(obj["execution"]) if obj.get("execution") is not None else None
        })
        return _obj
