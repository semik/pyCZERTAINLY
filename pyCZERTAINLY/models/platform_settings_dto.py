...
class PlatformSettingsDto(BaseModel):
    """
    PlatformSettingsDto
    """ # noqa: E501
    utils: UtilsSettingsDto
    __properties: ClassVar[List[str]] = ["utils"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "utils": UtilsSettingsDto.from_dict(obj["utils"]) if obj.get("utils") is not None else None
        })
        return _obj
