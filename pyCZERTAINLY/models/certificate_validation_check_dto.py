...
class CertificateValidationCheckDto(BaseModel):
    """
    Certificate validation check results
    """ # noqa: E501
    validation_check: CertificateValidationCheck = Field(alias="validationCheck")
    status: CertificateValidationStatus
    message: Optional[StrictStr] = Field(default=None, description="Certificate validation check result message")
    __properties: ClassVar[List[str]] = ["validationCheck", "status", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationCheck": obj.get("validationCheck"),
