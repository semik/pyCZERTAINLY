...
class EntityInstanceRequestDto(BaseModel):
    """
    EntityInstanceRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Entity instance name")
    attributes: List[RequestAttributeDto] = Field(description="List of Entity instance Attributes")
