...
class CredentialAttributeContentData(BaseModel):
    """
    ...
    attributes: List[DataAttribute] = Field(description="List of Credential Attributes")
    __properties: ClassVar[List[str]] = ["uuid", "name", "kind", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "kind": obj.get("kind"),
            "attributes": [DataAttribute.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
