...
class ConnectorUpdateRequestDto(BaseModel):
    """
    ConnectorUpdateRequestDto
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL of the Connector to connect")
    ...
    __properties: ClassVar[List[str]] = ["url", "authType", "authAttributes", "customAttributes"]
