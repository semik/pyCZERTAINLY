...
class AddTokenProfileRequestDto(BaseModel):
    """
    AddTokenProfileRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Token Profile name")
    description: Optional[StrictStr] = Field(default=None, description="Token Profile description")
    attributes: List[RequestAttributeDto] = Field(description="List of Attributes to create Token Profile")
    ...
    enabled: Optional[StrictBool] = Field(default=False, description="Enabled flag - true = enabled; false = disabled")
    usage: Optional[List[KeyUsage]] = Field(default=None, description="Usages for the Key")
    __properties: ClassVar[List[str]] = ["name", "description", "attributes", "customAttributes", "enabled", "usage"]
