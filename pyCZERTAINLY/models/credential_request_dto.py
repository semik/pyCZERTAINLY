...
class CredentialRequestDto(BaseModel):
    """
    CredentialRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Credential name")
    kind: StrictStr = Field(description="Credential Kind")
    attributes: List[RequestAttributeDto] = Field(description="List of Credential Attributes")
    ...
    __properties: ClassVar[List[str]] = ["name", "kind", "attributes", "customAttributes", "connectorUuid"]
