...
class CertificateEventHistoryDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uuid", "certificateUuid", "created", "createdBy", "event", "status", "message", "additionalInformation"]

    @field_validator('event')
    def event_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Issue Certificate', 'Request Certificate', 'Renew Certificate', 'Rekey Certificate', 'Revoke Certificate', 'Delete Certificate', 'Approve action requested', 'Approve action closed', 'Update State', 'Update Validation Status', 'Update RA Profile', 'Update Entity', 'Update Group', 'Update Owner', 'Upload Certificate', 'Certificate Discovered', 'Update Location']):
            raise ValueError("must be one of enum values ('Issue Certificate', 'Request Certificate', 'Renew Certificate', 'Rekey Certificate', 'Revoke Certificate', 'Delete Certificate', 'Approve action requested', 'Approve action closed', 'Update State', 'Update Validation Status', 'Update RA Profile', 'Update Entity', 'Update Group', 'Update Owner', 'Upload Certificate', 'Certificate Discovered', 'Update Location')")
        return value
