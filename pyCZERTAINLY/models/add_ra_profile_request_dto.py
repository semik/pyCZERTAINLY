...
class AddRaProfileRequestDto(BaseModel):
    """
    AddRaProfileRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="RA Profile name")
    description: Optional[StrictStr] = Field(default=None, description="RA Profile description")
    attributes: List[RequestAttributeDto] = Field(description="List of Attributes to create RA Profile")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "attributes", "customAttributes", "enabled"]
