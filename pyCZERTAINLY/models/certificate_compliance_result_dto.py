...
class CertificateComplianceResultDto(BaseModel):
    """
    ...
    rule_name: StrictStr = Field(description="Name of the rule", alias="ruleName")
    rule_description: StrictStr = Field(description="Description of the rule", alias="ruleDescription")
    status: ComplianceRuleStatus
    attributes: Optional[List[ResponseAttributeDto]] = Field(default=None, description="Attributes of the rule")
    __properties: ClassVar[List[str]] = ["connectorName", "ruleName", "ruleDescription", "status", "attributes"]
