...
class RuleDetailDto(BaseModel):
    ...
    resource: Resource
    conditions: List[ConditionDto] = Field(description="List of conditions in the Rule")
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "resource", "conditions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditions": [ConditionDto.from_dict(_item) for _item in obj["conditions"]] if obj.get("conditions") is not None else None
        })
        return _obj
