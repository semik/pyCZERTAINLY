...
class TokenProfileDetailDto(BaseModel):
    """
    ...
    attributes: List[ResponseAttributeDto] = Field(description="List of Token Profile attributes")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "tokenInstanceUuid", "tokenInstanceName", "attributes", "customAttributes", "tokenInstanceStatus", "enabled", "usages"]
