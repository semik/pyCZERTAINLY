...
class RaProfileScepDetailResponseDto(BaseModel):
    """
    ...
    scep_available: StrictBool = Field(description="SCEP availability flag - true = yes; false = no", alias="scepAvailable")
    url: Optional[StrictStr] = Field(default=None, description="SCEP URL")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "scepAvailable", "url", "issueCertificateAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uuid": obj.get("uuid"),
            "name": obj.get("name"),
            "scepAvailable": obj.get("scepAvailable"),
            "url": obj.get("url"),
