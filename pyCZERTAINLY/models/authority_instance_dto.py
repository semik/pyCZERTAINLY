...
class AuthorityInstanceDto(BaseModel):
    """
    AuthorityInstanceDto
    """ # noqa: E501
    uuid: StrictStr = Field(description="Object identifier")
    name: StrictStr = Field(description="Object Name")
    attributes: List[ResponseAttributeDto] = Field(description="List of Authority instance Attributes")
    ...
    status: StrictStr = Field(description="Status of Authority instance")
    connector_uuid: StrictStr = Field(description="UUID of Authority provider", alias="connectorUuid")
    connector_name: StrictStr = Field(description="Name of Authority provider", alias="connectorName")
    kind: StrictStr = Field(description="Authority Instance Kind")
    __properties: ClassVar[List[str]] = ["uuid", "name", "attributes", "customAttributes", "status", "connectorUuid", "connectorName", "kind"]
