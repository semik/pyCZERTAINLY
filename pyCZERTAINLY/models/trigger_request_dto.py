...
class TriggerRequestDto(BaseModel):
    """
    TriggerRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the trigger")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "type", "resource", "ignoreTrigger", "event", "eventResource", "rulesUuids", "actionsUuids"]
