...
class UserDetailDto(BaseModel):
    ...
    UserDetailDto
    """ # noqa: E501
    uuid: StrictStr = Field(description="UUID of the User")
    ...
    groups: List[NameAndUuidDto] = Field(description="Groups of the user")
    enabled: StrictBool = Field(description="Status of the user. True = Enabled, False = Disabled")
    system_user: StrictBool = Field(description="Is System user. True = Yes, False = No", alias="systemUser")
    certificate: Optional[UserCertificateDto] = None
    roles: List[RoleDto] = Field(description="Roles for the user")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "username", "firstName", "lastName", "email", "description", "groups", "enabled", "systemUser", "certificate", "roles", "customAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [NameAndUuidDto.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "enabled": obj.get("enabled"),
            "systemUser": obj.get("systemUser"),
            "certificate": UserCertificateDto.from_dict(obj["certificate"]) if obj.get("certificate") is not None else None,
