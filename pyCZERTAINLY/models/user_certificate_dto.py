...
class UserCertificateDto(BaseModel):
    """
    User Certificate details
    """ # noqa: E501
    uuid: StrictStr = Field(description="UUID of the certificate")
    fingerprint: StrictStr = Field(description="Fingerprint of the certificate")
    __properties: ClassVar[List[str]] = ["uuid", "fingerprint"]
