...
class TestRaProfileDto(unittest.TestCase):
    """RaProfileDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RaProfileDto:
        """Test RaProfileDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RaProfileDto`
        """
        model = RaProfileDto()
        if include_optional:
            return RaProfileDto(
