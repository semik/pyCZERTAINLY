...
class TestNotificationInstanceRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NotificationInstanceRequestDto:
        """Test NotificationInstanceRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationInstanceRequestDto`
        """
        model = NotificationInstanceRequestDto()
        if include_optional:
    ...
    def testNotificationInstanceRequestDto(self):
        """Test NotificationInstanceRequestDto"""
