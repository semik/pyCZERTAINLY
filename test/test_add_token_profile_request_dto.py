...
class TestAddTokenProfileRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddTokenProfileRequestDto:
        """Test AddTokenProfileRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddTokenProfileRequestDto`
        """
        model = AddTokenProfileRequestDto()
        if include_optional:
    ...
    def testAddTokenProfileRequestDto(self):
        """Test AddTokenProfileRequestDto"""
