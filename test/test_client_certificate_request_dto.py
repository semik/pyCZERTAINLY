...
class TestClientCertificateRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientCertificateRequestDto:
        """Test ClientCertificateRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientCertificateRequestDto`
        """
        model = ClientCertificateRequestDto()
        if include_optional:
    ...
    def testClientCertificateRequestDto(self):
        """Test ClientCertificateRequestDto"""
