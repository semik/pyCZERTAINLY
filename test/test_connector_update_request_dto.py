...
class TestConnectorUpdateRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConnectorUpdateRequestDto:
        """Test ConnectorUpdateRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectorUpdateRequestDto`
        """
        model = ConnectorUpdateRequestDto()
        if include_optional:
            return ConnectorUpdateRequestDto(
    ...
    def testConnectorUpdateRequestDto(self):
        """Test ConnectorUpdateRequestDto"""
