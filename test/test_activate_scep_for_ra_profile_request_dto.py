...
class TestActivateScepForRaProfileRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActivateScepForRaProfileRequestDto:
        """Test ActivateScepForRaProfileRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivateScepForRaProfileRequestDto`
        """
        model = ActivateScepForRaProfileRequestDto()
        if include_optional:
    ...
    def testActivateScepForRaProfileRequestDto(self):
        """Test ActivateScepForRaProfileRequestDto"""
