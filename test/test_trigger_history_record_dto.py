...
class TestTriggerHistoryRecordDto(unittest.TestCase):
    """TriggerHistoryRecordDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerHistoryRecordDto:
        """Test TriggerHistoryRecordDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerHistoryRecordDto`
        """
        model = TriggerHistoryRecordDto()
        if include_optional:
    ...
    def testTriggerHistoryRecordDto(self):
        """Test TriggerHistoryRecordDto"""
