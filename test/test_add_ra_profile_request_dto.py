...
class TestAddRaProfileRequestDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddRaProfileRequestDto:
        """Test AddRaProfileRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddRaProfileRequestDto`
        """
        model = AddRaProfileRequestDto()
        if include_optional:
    ...
    def testAddRaProfileRequestDto(self):
        """Test AddRaProfileRequestDto"""
