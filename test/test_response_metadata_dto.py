...
class TestResponseMetadataDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResponseMetadataDto:
        """Test ResponseMetadataDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseMetadataDto`
        """
        model = ResponseMetadataDto()
        if include_optional:
    ...
    def testResponseMetadataDto(self):
        """Test ResponseMetadataDto"""
