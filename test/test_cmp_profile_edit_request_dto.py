...
class TestCmpProfileEditRequestDto(unittest.TestCase):
    """CmpProfileEditRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CmpProfileEditRequestDto:
        """Test CmpProfileEditRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CmpProfileEditRequestDto`
        """
        model = CmpProfileEditRequestDto()
        if include_optional:
            return CmpProfileEditRequestDto(
    ...
    def testCmpProfileEditRequestDto(self):
        """Test CmpProfileEditRequestDto"""
