...
class TestBaseAttributeDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BaseAttributeDto:
        """Test BaseAttributeDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseAttributeDto`
        """
        model = BaseAttributeDto()
        if include_optional:
