...
class TestFunctionGroupDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FunctionGroupDto:
        """Test FunctionGroupDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionGroupDto`
        """
        model = FunctionGroupDto()
        if include_optional:
