...
class TestCertificateResponseDto(unittest.TestCase):
    """CertificateResponseDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificateResponseDto:
        """Test CertificateResponseDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificateResponseDto`
        """
        model = CertificateResponseDto()
        if include_optional:
    ...
    def testCertificateResponseDto(self):
        """Test CertificateResponseDto"""
