...
class TestDataAttributeProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataAttributeProperties:
        """Test DataAttributeProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataAttributeProperties`
        """
        model = DataAttributeProperties()
        if include_optional:
    ...
    def testDataAttributeProperties(self):
        """Test DataAttributeProperties"""
