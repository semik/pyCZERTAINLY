...
class TestMetadataResponseDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MetadataResponseDto:
        """Test MetadataResponseDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetadataResponseDto`
        """
        model = MetadataResponseDto()
        if include_optional:
    ...
    def testMetadataResponseDto(self):
        """Test MetadataResponseDto"""
