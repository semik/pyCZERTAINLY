...
class TestCertificateRequestDto(unittest.TestCase):
    """CertificateRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificateRequestDto:
        """Test CertificateRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificateRequestDto`
        """
        model = CertificateRequestDto()
        if include_optional:
    ...
    def testCertificateRequestDto(self):
        """Test CertificateRequestDto"""
