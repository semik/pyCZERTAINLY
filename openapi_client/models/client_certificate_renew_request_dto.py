...
class ClientCertificateRenewRequestDto(BaseModel):
    """
    ...
    request: Optional[StrictStr] = Field(default=None, description="Certificate signing request encoded as Base64 string. If not provided, Existing CSR will be used")
    format: Optional[CertificateRequestFormat] = CertificateRequestFormat.PKCS10
    __properties: ClassVar[List[str]] = ["replaceInLocations", "request", "format"]
