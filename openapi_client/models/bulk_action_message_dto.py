...
class BulkActionMessageDto(BaseModel):
    """
    BulkActionMessageDto
    """ # noqa: E501
    uuid: StrictStr = Field(description="Object identifier")
    name: StrictStr = Field(description="Object Name")
    message: StrictStr = Field(description="Message describing the associations of the Objects which is preventing the bulk operation")
    __properties: ClassVar[List[str]] = ["uuid", "name", "message"]
