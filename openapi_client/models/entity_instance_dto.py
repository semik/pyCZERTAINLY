...
class EntityInstanceDto(BaseModel):
    """
    EntityInstanceDto
    """ # noqa: E501
    uuid: StrictStr = Field(description="Object identifier")
    name: StrictStr = Field(description="Object Name")
    attributes: List[ResponseAttributeDto] = Field(description="List of Entity instance Attributes")
    ...
    status: StrictStr = Field(description="Status of Entity instance")
    connector_uuid: StrictStr = Field(description="UUID of Entity Provider", alias="connectorUuid")
    connector_name: StrictStr = Field(description="Name of Entity Provider", alias="connectorName")
    kind: StrictStr = Field(description="Entity instance Kind")
