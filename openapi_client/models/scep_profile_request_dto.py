...
class ScepProfileRequestDto(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the SCEP Profile")
    __properties: ClassVar[List[str]] = ["description", "raProfileUuid", "issueCertificateAttributes", "caCertificateUuid", "customAttributes", "renewalThreshold", "includeCaCertificate", "includeCaCertificateChain", "challengePassword", "enableIntune", "intuneTenant", "intuneApplicationId", "intuneApplicationKey", "name"]
