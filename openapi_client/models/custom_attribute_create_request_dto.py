...
class CustomAttributeCreateRequestDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "contentType", "description", "label", "visible", "group", "required", "readOnly", "list", "multiSelect", "content", "resources"]
