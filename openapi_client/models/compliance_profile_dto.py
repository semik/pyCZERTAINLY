...
class ComplianceProfileDto(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of the Compliance Profile")
    rules: List[ComplianceConnectorAndRulesDto] = Field(description="List of rules")
    groups: List[ComplianceConnectorAndGroupsDto] = Field(description="List of groups")
    ra_profiles: Optional[List[SimplifiedRaProfileDto]] = Field(default=None, description="List of associated RA Profiles", alias="raProfiles")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "rules", "groups", "raProfiles", "customAttributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.groups:
            ...
            _dict['groups'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in ra_profiles (list)
        _items = []
        if self.ra_profiles:
            for _item_ra_profiles in self.ra_profiles:
                if _item_ra_profiles:
                    _items.append(_item_ra_profiles.to_dict())
            _dict['raProfiles'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [ComplianceConnectorAndRulesDto.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
            "groups": [ComplianceConnectorAndGroupsDto.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "raProfiles": [SimplifiedRaProfileDto.from_dict(_item) for _item in obj["raProfiles"]] if obj.get("raProfiles") is not None else None,
