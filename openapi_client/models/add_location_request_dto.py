...
class AddLocationRequestDto(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Location name")
    description: Optional[StrictStr] = Field(default=None, description="Location description")
    attributes: List[RequestAttributeDto] = Field(description="List of Attributes to register Location")
