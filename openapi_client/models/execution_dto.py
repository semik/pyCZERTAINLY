...
class ExecutionDto(BaseModel):
    ...
    type: ExecutionType
    resource: Resource
    items: List[ExecutionItemDto] = Field(description="List of the execution items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ExecutionItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
