...
class AcmeAccountListResponseDto(BaseModel):
    """
    ...
    total_orders: StrictInt = Field(description="Total number of Orders", alias="totalOrders")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "uuid", "enabled", "totalOrders", "status", "raProfile", "acmeProfileName", "acmeProfileUuid"]
