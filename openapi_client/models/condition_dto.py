...
class ConditionDto(BaseModel):
    ...
    type: ConditionType
    resource: Resource
    items: List[ConditionItemDto] = Field(description="List of the condition items")
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "type", "resource", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ConditionItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
