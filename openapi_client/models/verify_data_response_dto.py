...
class VerifyDataResponseDto(BaseModel):
    """
    VerifyDataResponseDto
    """ # noqa: E501
    verifications: List[VerificationResponseData] = Field(description="Signatures")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verifications": [VerificationResponseData.from_dict(_item) for _item in obj["verifications"]] if obj.get("verifications") is not None else None
        })
        return _obj
