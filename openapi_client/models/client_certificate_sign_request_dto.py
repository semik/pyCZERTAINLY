...
class ClientCertificateSignRequestDto(BaseModel):
    """
    ...
    request: StrictStr = Field(description="Certificate signing request encoded as Base64 string")
    ...
    attributes: List[RequestAttributeDto] = Field(description="List of RA Profile related Attributes to issue Certificate")
    ...
    __properties: ClassVar[List[str]] = ["csrAttributes", "signatureAttributes", "request", "format", "tokenProfileUuid", "keyUuid", "attributes", "customAttributes"]
