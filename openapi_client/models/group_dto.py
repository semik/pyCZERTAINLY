...
class GroupDto(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Group contact email")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "email", "customAttributes"]
