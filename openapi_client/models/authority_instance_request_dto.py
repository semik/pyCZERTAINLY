...
class AuthorityInstanceRequestDto(BaseModel):
    """
    AuthorityInstanceRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Authority instance name")
    attributes: List[RequestAttributeDto] = Field(description="List of Authority instance Attributes")
    ...
    __properties: ClassVar[List[str]] = ["name", "attributes", "customAttributes", "connectorUuid", "kind"]
