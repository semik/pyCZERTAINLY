...
class TokenInstanceRequestDto(BaseModel):
    """
    TokenInstanceRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Token Instance")
    description: Optional[StrictStr] = Field(default=None, description="Token Instance description")
    connector_uuid: StrictStr = Field(description="UUID of the Connector", alias="connectorUuid")
    kind: StrictStr = Field(description="Connector Kind")
    custom_attributes: List[RequestAttributeDto] = Field(description="Custom Attributes", alias="customAttributes")
    attributes: List[RequestAttributeDto] = Field(description="Attributes for Token Instance")
    __properties: ClassVar[List[str]] = ["name", "description", "connectorUuid", "kind", "customAttributes", "attributes"]
