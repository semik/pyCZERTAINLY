...
class CodeBlockAttributeContentData(BaseModel):
    """
    CodeBlock attribute content data
    """ # noqa: E501
    language: ProgrammingLanguageEnum
    code: StrictStr = Field(description="Block of the code in Base64. Formatting of the code is specified by variable language")
