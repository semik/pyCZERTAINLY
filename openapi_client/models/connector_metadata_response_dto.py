...
class ConnectorMetadataResponseDto(BaseModel):
    """
    ConnectorMetadataResponseDto
    """ # noqa: E501
    name: StrictStr = Field(description="Metadata Name")
    uuid: StrictStr = Field(description="Metadata UUID")
    content_type: AttributeContentType = Field(alias="contentType")
    label: StrictStr = Field(description="Metadata Label")
    connector_uuid: StrictStr = Field(description="Connector UUID", alias="connectorUuid")
    __properties: ClassVar[List[str]] = ["name", "uuid", "contentType", "label", "connectorUuid"]
