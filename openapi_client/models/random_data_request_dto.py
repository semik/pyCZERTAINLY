...
class RandomDataRequestDto(BaseModel):
    """
    RandomDataRequestDto
    """ # noqa: E501
    length: StrictInt = Field(description="Number of random bytes to generate")
    attributes: Optional[List[RequestAttributeDto]] = Field(default=None, description="Random generator Attributes")
    __properties: ClassVar[List[str]] = ["length", "attributes"]
