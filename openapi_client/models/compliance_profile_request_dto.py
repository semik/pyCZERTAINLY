...
class ComplianceProfileRequestDto(BaseModel):
    """
    ComplianceProfileRequestDto
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Compliance Profile")
    description: Optional[StrictStr] = Field(default=None, description="Description of the Compliance Profile")
    rules: Optional[List[ComplianceProfileRulesRequestDto]] = Field(default=None, description="Rules to be associated with the Compliance Profile. Profiles can be created without rules and can be added later")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "rules", "customAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [ComplianceProfileRulesRequestDto.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
