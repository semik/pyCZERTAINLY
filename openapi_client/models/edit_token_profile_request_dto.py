...
class EditTokenProfileRequestDto(BaseModel):
    """
    EditTokenProfileRequestDto
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of Token Profile")
    attributes: List[RequestAttributeDto] = Field(description="List of Attributes for Token Profile")
    ...
    __properties: ClassVar[List[str]] = ["description", "attributes", "customAttributes", "enabled", "usage"]
