...
class ActionDetailDto(BaseModel):
    ...
    resource: Resource
    executions: List[ExecutionDto] = Field(description="List of executions")
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "resource", "executions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "executions": [ExecutionDto.from_dict(_item) for _item in obj["executions"]] if obj.get("executions") is not None else None
        })
        return _obj
