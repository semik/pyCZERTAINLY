...
class AcmeProfileEditRequestDto(BaseModel):
    """
    ...
    terms_of_service_change_disable: Optional[StrictBool] = Field(default=False, description="Disable new Orders due to change in Terms of Service", alias="termsOfServiceChangeDisable")
    ...
    __properties: ClassVar[List[str]] = ["description", "termsOfServiceUrl", "websiteUrl", "dnsResolverIp", "dnsResolverPort", "raProfileUuid", "retryInterval", "termsOfServiceChangeDisable", "termsOfServiceChangeUrl", "validity", "issueCertificateAttributes", "revokeCertificateAttributes", "requireContact", "requireTermsOfService", "customAttributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "termsOfServiceChangeDisable": obj.get("termsOfServiceChangeDisable") if obj.get("termsOfServiceChangeDisable") is not None else False,
